...
lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.o: /project/ollvm-src/lib/ToolDrivers/llvm-dlltool/DlltoolDriver.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/project/ollvm-bin/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.o"
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.o -c /project/ollvm-src/lib/ToolDrivers/llvm-dlltool/DlltoolDriver.cpp
...
lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.i: cmake_force
	...
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /project/ollvm-src/lib/ToolDrivers/llvm-dlltool/DlltoolDriver.cpp > CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.i
...
lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.s: cmake_force
	...
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /project/ollvm-src/lib/ToolDrivers/llvm-dlltool/DlltoolDriver.cpp -o CMakeFiles/LLVMDlltoolDriver.dir/DlltoolDriver.cpp.s
...
lib/libLLVMDlltoolDriver.a: lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/project/ollvm-bin/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library ../../libLLVMDlltoolDriver.a"
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && $(CMAKE_COMMAND) -P CMakeFiles/LLVMDlltoolDriver.dir/cmake_clean_target.cmake
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/LLVMDlltoolDriver.dir/link.txt --verbose=$(VERBOSE)
...
lib/ToolDrivers/llvm-dlltool/CMakeFiles/LLVMDlltoolDriver.dir/clean:
	cd /project/ollvm-bin/lib/ToolDrivers/llvm-dlltool && $(CMAKE_COMMAND) -P CMakeFiles/LLVMDlltoolDriver.dir/cmake_clean.cmake
